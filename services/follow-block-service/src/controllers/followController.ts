...
export const getUserFollowsHandler = async (req: Request, res: Response) => {
    try {
        ...
        res.status(200).json({ message: "Follows retrieved successfully.", follows })
    } catch (error) {
...
export const getFollowByIdHandler = async (req: Request, res: Response) => {
    try {
        ...
        res.status(200).json({ message: "Follow retrieved successfully.", follow })
    } catch (error) {
...
export const followUser = async (req: Request, res: Response) => {
    try {
        ...
        res.status(201).json({ message: "Followed successfully.", createdFollow })
    } catch (error) {
